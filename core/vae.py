...
class Encoder(nn.Module):
    ...
    def __init__(self, channels, ch=cnfg.channels, blocks=cnfg.blocks, latent_channels=cnfg.latent_channels):
...
class VAE(nn.Module):
    ...
    """
    def __init__(self, channel_in=3, ch=cnfg.channels, blocks=cnfg.blocks, latent_channels=cnfg.latent_channels):
